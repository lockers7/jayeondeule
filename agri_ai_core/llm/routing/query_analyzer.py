...
from agri_ai_core.llm.routing.query_classifier import classify_query_fast, QueryType
from agri_ai_core.llm.routing.context_collector import collect_context_parallel
from agri_ai_core.llm.routing.response_generator import (
...
async def analyze_and_respond_unified(
    ...
    try:
        ...
        if classification.get("can_answer_directly"):
            ...
            from agri_ai_core.llm.routing.response_generator import generate_direct_response
