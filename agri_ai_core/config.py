...
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 컬렉션 이름 목록 (순환 import 방지를 위해 주석 처리)
# 컬렉션 이름은 CollectionSettings에 정의되어 있으며, 필요시 src.chroma.collections에서 직접 import하세요
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# NOTE: 아래 코드는 순환 import를 일으키므로 주석 처리함
...
def get_farm_name(farm_id=None, house_id=None):
    ...
    try:
        # config 모듈의 순환 import를 피하기 위해 지연 import 사용
