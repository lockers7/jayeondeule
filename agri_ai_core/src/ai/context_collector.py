...
async def collect_farm_realtime_data(required_data: Dict[str, Any]) -> Dict[str, Any]:
    try:
        from agri_ai_core.src.postgresql.connection import DatabaseHandler
        from agri_ai_core.src.postgresql.queries import GET_NOW_UNIT_INFO, GET_LATEST_RELAY_INFO
