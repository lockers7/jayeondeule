# ════════════════════════════════════════════════════════════════════
# 파일 처리 — 업로드 파일(CSV/Excel/PDF/텍스트) 을 LLM 입력 텍스트로 변환.
# --->
# _format_dataframe       : DataFrame → 요약 텍스트 (CSV/Excel 공용)
# read_csv_file           : CSV 파일 읽기
# read_excel_file         : Excel 파일 읽기 (다중 시트 지원)
# read_text_file          : 텍스트 파일 읽기
# read_pdf_file           : PDF 파일 텍스트 추출
# process_uploaded_files  : 다중 업로드 파일 일괄 변환
# ════════════════════════════════════════════════════════════════════
import os
import pandas as pd
