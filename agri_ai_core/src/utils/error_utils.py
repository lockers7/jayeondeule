...
# ────────────────────────────────────────────────────────────────────
# 함수 전체를 try/except 로 감싸 예외 발생 시 로그 기록 후 default 반환.
# 사용 예:
...
#     logger     : 사용할 logger (None 이면 함수 모듈의 logger 자동 사용)
#     message    : 로그 메시지 접두사 (None 이면 함수명 사용)
# ────────────────────────────────────────────────────────────────────
def log_and_return(default: Any = None,
    ...
    # ────────────────────────────────────────────────────────────────
    # 데코레이터 본체 — wrapper 를 생성해 반환.
    # ────────────────────────────────────────────────────────────────
    def decorator(func: Callable) -> Callable:
        @wraps(func)
        # ────────────────────────────────────────────────────────────
        # try/except 로 func 호출을 감싼 실제 wrapper.
        # ────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────
# with 블록 내부 예외를 로그 기록 후 무시 (컨텍스트 매니저).
# 사용 예:
