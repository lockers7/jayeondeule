...
from agri_ai_core.src.ai.rag.document_processor import (
    process_attached_files, llm_document_process,
    messages_to_text, format_rag_save_result,
)
    ...
    async def save_rag(self):
        ...
        try:
            ...
            conversation_text = messages_to_text(
                messages_snapshot, farm_name, house_name,
            )
            ...
            # 공통 함수로 결과 포맷팅
            success, message = format_rag_save_result(result, len(messages_snapshot))
