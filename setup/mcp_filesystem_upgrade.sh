...
# -*- coding: utf-8 -*-
# =========================================================================
# MCP postgres 서버 (@modelcontextprotocol/server-filesystem) 버전 확인 / 갱신
# -----------------------------------------
# npx 캐시 기반 — 별도 install 없이 다음 실행 시 최신 버전 자동 사용.
#
# 사용법:
#   bash setup/mcp_filesystem_upgrade.sh          # 버전 확인만
#   bash setup/mcp_filesystem_upgrade.sh check    # 버전 확인만
#   bash setup/mcp_filesystem_upgrade.sh upgrade  # npx 캐시 갱신
# =========================================================================
...
check_version() {
    ...
    echo ""
    log_warn "캐시 갱신: bash setup/mcp_filesystem_upgrade.sh upgrade"
}
